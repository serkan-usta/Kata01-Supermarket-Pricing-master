...
public class CalculateTotal implements PricingScheme {

    private final List<Item> items;
    private final int volume;

    public CalculateTotal(List<Item> items, int volume) {
        this.items = items;
        this.volume = volume;
    }
    ...
    public BigDecimal calculateAll() {
        return PricingScheme.subtotal(items).subtract(makeDiscount());
    }
}
